...
class App:
    ...
    def _build_detection_tab(self):
        ...
        params = [
            ...
            ("min_scratch_length_px", "最小长度", 5, 500, int(SCRATCH_CFG.min_scratch_length_px)),
            ("gabor_ksize", "Gabor尺寸", 3, 51, int(SCRATCH_CFG.gabor_ksize)),
        ]
